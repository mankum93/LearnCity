 ...
 */
public class CreditsParcelable implements Parcelable {
    ...
    public static final Parcelable.Creator<CreditsParcelable> CREATOR = new Parcelable.Creator<CreditsParcelable>() {
        @Override
        public CreditsParcelable createFromParcel(Parcel in) {
            return new CreditsParcelable(in);
        }

        @Override
        public CreditsParcelable[] newArray(int size) {
            return new CreditsParcelable[size];
        }
    };
}
