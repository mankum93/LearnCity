package com.learncity.util.ver0;
...
import com.learncity.generic.learner.account.create.ver0.GAEAccountCreationTask;
import com.learncity.generic.learner.account.create.ver0.SQLiteAccountCreationTask;
import com.learncity.util.ver1.AccountCreationWorkerThreadVer1;
...
public class AccountCreationManager {
    ...
    private AccountCreationWorkerThreadVer1 workerThread;
    ...
    private AccountCreationManager(@NonNull Context context){
        ...
        workerThread = new AccountCreationWorkerThreadVer1("AccountCreationManager");
    ...
    public void startAccountCreation(@NonNull GenericLearnerProfile profile, final int accountCreationFlag){

        Log.d(TAG, "AccountCreationManager.startTasksProcessing(): " + "\n" + "MESSAGE: Called from the MAIN thread to initiate the AC creation..." +
                ...
                switch(accountCreationFlag){
                    ...
                    case CREATE_ACCOUNT_LOCAL:
                        ...
                        if(localAccountCreationListener != null){
                            Log.d(TAG, "AccountCreationManager.startTasksProcessing(): " + "\n" + "MESSAGE: Calling localAccountCreationListener.onPreTaskProcessingStart()..." +
                                    "\n" +"Thread ID: " + Thread.currentThread().getId());
                    ...
                    case CREATE_ACCOUNT_SERVER:
                        ...
                        if(serverAccountCreationListener != null){
                            Log.d(TAG, "AccountCreationManager.startTasksProcessing(): " + "\n" + "MESSAGE: Calling serverAccountCreationListener.onPreTaskProcessingStart()..." +
                                    "\n" +"Thread ID: " + Thread.currentThread().getId());
                    ...
                    case CREATE_ACCOUNT_SERVER_LOCAL:
                        ...
                        if(accountCreationListener != null){
                            Log.d(TAG, "AccountCreationManager.startTasksProcessing(): " + "\n" + "MESSAGE: Calling accountCreationListener.onPreTaskProcessingStart()..." +
                                    "\n" +"Thread ID: " + Thread.currentThread().getId());
    ...
    public void startAccountCreation(@NonNull GenericLearnerProfile profile){
        Log.d(TAG, "AccountCreationManager.startTasksProcessing(): " + "\n" + "MESSAGE: Called from the MAIN thread to initiate the AC creation..." +
                "\n" +"Thread ID: " + Thread.currentThread().getId());
        if(profile == null){
            throw new NullPointerException("Profile to be inserted cannot be null");
        ...
        if((accountCreationMode & GAE_ACCOUNT_CREATION_MODE) == GAE_ACCOUNT_CREATION_MODE){
            ...
            task.setAccountCreationListener(new AccountCreationTask.AccountCreationTaskListener() {
                ...
                public void onAccountCreated() {
                    Log.d(TAG, "AccountCreationTaskListener.onTaskProcessingComplete(): " + "\n" + "MESSAGE: AC created on GAE!!!" +
                            "\n" +"Thread ID: " + Thread.currentThread().getId());
                    ...
                    if(serverAccountCreationListener != null){
                        ...
                        Log.d(TAG, "AccountCreationTaskListener.onTaskProcessingComplete(): " + "\n" + "MESSAGE: Calling TaskProcessorListener.onPostAccountCreation()..." +
                                "\n" +"Thread ID: " + Thread.currentThread().getId());
                ...
                public void onAccountCreationFailed() {
                    Log.e(TAG, "AccountCreationTaskListener.onTaskProcessingFailed(): " + "\n" + "MESSAGE: AC creation failed on GAE!!!" +
                            "\n" +"Thread ID: " + Thread.currentThread().getId());
                    //Update the AC creation state
                    ...
                    * and we shall resume then or if the user asks us to wrap it up here then be it)*/
                    if(serverAccountCreationListener != null){
                        t = new Thread(new Runnable() {
                            @Override
                            public void run() {
                                Log.d(TAG, "AccountCreationTaskListener.onTaskProcessingFailed(): " + "\n" + "MESSAGE: Calling TaskProcessorListener.onTaskProcessingFailed()..." +
                                        "\n" +"Thread ID: " + Thread.currentThread().getId());
                    ...
                    if(shouldAccountCreationBeRetried){
                        ...
                        if(accountCreationListener != null){
                            t = new Thread(new Runnable() {
                                @Override
                                public void run() {
                                    Log.d(TAG, "TaskProcessorListener.onTaskProcessingFailed(): " + "\n" + "MESSAGE: Calling TaskProcessorListener.onTaskProcessingFailed()..." +
                                            "\n" +"Thread ID: " + Thread.currentThread().getId());
        ...
        if((accountCreationMode & SQLITE_ACCOUNT_CREATION_MODE) == SQLITE_ACCOUNT_CREATION_MODE){
            ...
            task.setAccountCreationListener(new AccountCreationTask.AccountCreationTaskListener() {
                ...
                public void onAccountCreated() {
                    ...
                    if(localAccountCreationListener != null){
                        Log.d(TAG, "AccountCreationTaskListener.onTaskProcessingComplete(): " + "\n" + "MESSAGE: Calling LOCAL TaskProcessorListener.onTaskProcessingComplete()..." +
                                "\n" +"Thread ID: " + Thread.currentThread().getId());
                        localAccountCreationListener.onAccountCreated();
                        Log.d(TAG, "AccountCreationTaskListener.onTaskProcessingComplete(): " + "\n" + "MESSAGE: Calling LOCAL TaskProcessorListener.onPostAccountCreation()..." +
                                "\n" +"Thread ID: " + Thread.currentThread().getId());
                        localAccountCreationListener.onPostAccountCreation();
                    }
                    if(accountCreationListener != null){
                        Log.d(TAG, "AccountCreationTaskListener.onTaskProcessingComplete(): " + "\n" + "MESSAGE: Calling SERVER TaskProcessorListener.onTaskProcessingComplete()..." +
                                "\n" +"Thread ID: " + Thread.currentThread().getId());
                        accountCreationListener.onAccountCreated();
                        Log.d(TAG, "AccountCreationTaskListener.onTaskProcessingComplete(): " + "\n" + "MESSAGE: Calling SERVER TaskProcessorListener.onPostAccountCreation()..." +
                                "\n" +"Thread ID: " + Thread.currentThread().getId());
                    ...
                    * and we shall resume then or if the user asks us to wrap it up here then be it)*/
                    if(localAccountCreationListener != null){
                        t = new Thread(new Runnable() {
                            @Override
                            public void run() {
                                Log.d(TAG, "AccountCreationTaskListener.onTaskProcessingFailed(): " + "\n" + "MESSAGE: Calling LOCAL TaskProcessorListener.onTaskProcessingFailed()..." +
                                        "\n" +"Thread ID: " + Thread.currentThread().getId());
                                localAccountCreationListener.onAccountCreationFailed();
                                if(accountCreationListener != null){
                                    Log.d(TAG, "AccountCreationTaskListener.onTaskProcessingFailed(): " + "\n" + "MESSAGE: Calling OVERALL TaskProcessorListener.onTaskProcessingFailed()..." +
                                            "\n" +"Thread ID: " + Thread.currentThread().getId());
                                    accountCreationListener.onAccountCreationFailed();
                                }
                            }
