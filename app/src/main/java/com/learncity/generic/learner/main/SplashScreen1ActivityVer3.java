...
import com.learncity.generic.learner.account.create.NewAccountCreationActivityVer4;
...
public class SplashScreen1ActivityVer3 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        startActivity(new Intent(this, NewAccountCreationActivityVer4.class));
