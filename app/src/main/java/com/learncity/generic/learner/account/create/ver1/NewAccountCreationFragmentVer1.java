...
public class NewAccountCreationFragmentVer1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        signUpWithEmailButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Intent i = new Intent(getActivity(), SignUpWithEmailActivityVer1.class);
                startActivity(i);
            }
        });
    ...
    private void initializeGoogleApiClient() {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                ...
                .requestId()
                .build();
        mGoogleApiClient = new GoogleApiClient.Builder(NewAccountCreationFragmentVer1.this.getActivity())
                .enableAutoManage(NewAccountCreationFragmentVer1.this.getActivity(), new GoogleApiClient.OnConnectionFailedListener() {
                    @Override
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            createACWithGoogle.putExtra(SignUpWithGoogleAccountActivityVer1.EXTRAS_GENERIC_PROFILE_INCOMPLETE, profile);
