...
public class NewAccountCreationFragmentVer3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        signUpWithEmailButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Intent i = new Intent(getActivity(), SignUpWithEmailActivityVer3.class);
                startActivity(i);
            }
        });
    ...
    private void initializeGoogleApiClient() {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                ...
                .requestId()
                .build();
        mGoogleApiClient = new GoogleApiClient.Builder(NewAccountCreationFragmentVer3.this.getActivity())
                .enableAutoManage(NewAccountCreationFragmentVer3.this.getActivity(), new GoogleApiClient.OnConnectionFailedListener() {
                    @Override
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            Intent createACWithGoogle = new Intent(this.getActivity(), SignUpWithGoogleAccountActivityVer3.class);
            createACWithGoogle.putExtra(SignUpWithGoogleAccountActivityVer3.EXTRAS_GENERIC_PROFILE_INCOMPLETE, profile);
