...
import com.learncity.backend.common.account.create.ver0.GenericLearnerProfile;
...
public class GenericLearnerProfilePersistenceEndpoint {

    private static final Logger logger = Logger.getLogger(GenericLearnerProfilePersistenceEndpoint.class.getName());
