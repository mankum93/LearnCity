...
public class TutorProfileVer2PersistenceEndpoint extends BaseLearnerEndpoint{

    private static final Logger logger = Logger.getLogger(TutorProfileVer2PersistenceEndpoint.class.getName());
