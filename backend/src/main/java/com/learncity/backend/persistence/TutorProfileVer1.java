...
public class TutorProfileVer1 extends GenericLearnerProfileVer1 {
    ...
    public static class Builder {
        ...
        private TutorProfileVer1 tutorProfile;
        ...
        public TutorProfileVer1 build() {
            ...
            tutorProfile = new TutorProfileVer1(name, emailID, phoneNo,
                    currentStatus, password, imagePath, lastKnownGeoCoordinates, educationalQualifications,
                    occupation, tutorTypes, disciplines, rating, teachingCredits);
        ...
        public TutorProfileVer1 getBuiltObject(){
            if(tutorProfile == null){
    ...
    public TutorProfileVer1 setState(String name,
                                     String emailID,
                                     String phoneNo,
                                     int currentStatus,
                                     String password,
    ...
    public TutorProfileVer1(String name,
                            String emailID,
                            String phoneNo,
                            int currentStatus,
                            String password,
    ...
    public static TutorProfileVer1 validateTutorProfile(TutorProfileVer1 tutorProfile){
        //The base class fields shall be checked before the current one
        tutorProfile = (TutorProfileVer1) GenericLearnerProfileVer1.validateGenericLearnerProfile(tutorProfile);
