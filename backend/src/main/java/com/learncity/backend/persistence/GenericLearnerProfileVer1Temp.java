...
@Entity
public class GenericLearnerProfileVer1Temp {
    ...
    public static class Builder {
        ...
        @Ignore
        private GenericLearnerProfileVer1Temp learnerProfile;
        ...
        public GenericLearnerProfileVer1Temp build() {
            ...
            learnerProfile = new GenericLearnerProfileVer1Temp(name, emailID, phoneNo,
                    currentStatus, password, imagePath, geoCoordinates);
        ...
        public GenericLearnerProfileVer1Temp getBuiltObject(){
            if(learnerProfile == null){
    ...
    public GenericLearnerProfileVer1Temp setState(String name,
                                                  String emailID,
                                                  String phoneNo,
                                                  int currentStatus,
                                                  String password,
    ...
    public GenericLearnerProfileVer1Temp(String name,
                                         String emailID,
                                         String phoneNo,
                                         int currentStatus,
                                         String password,
    ...
    public GenericLearnerProfileVer1Temp(){
    ...
    public static GenericLearnerProfileVer1Temp validateGenericLearnerProfile(GenericLearnerProfileVer1Temp learnerProfile){
        //Validating the Name
